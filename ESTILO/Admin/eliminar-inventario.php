      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <?php
			...
			$eli = "SELECT * FROM productos WHERE idProductos=" .$eliminar;
	...
	if($resultCheck > 0) {
        ...
        <div class="modal-footer">
          <div style="text-align: right;">
							<a  href="registros/elimi-inventario.php?reg=<?php echo $id; ?>" type="button" class="btn btn-default">Eliminar</a>
