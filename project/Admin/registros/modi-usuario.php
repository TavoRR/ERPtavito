...
<?php
	...
	$_GUARDAR_SQL = "UPDATE usuarios SET nombre='$nombre', Tipo='$tipo', Password='$password' WHERE idUsuarios='$id'";
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <h3>Los datos se han modificado con exito</h3> 
        </div>
        <div class="modal-footer">
          <div style="text-align: right;">
							
							<a href=" ../usuarios.php" type="button" class="btn btn-danger">Cerrar</a>
							<br><br>
						</div>
        </div>
      </div>
