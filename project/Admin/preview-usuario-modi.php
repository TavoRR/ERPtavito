...
<a href="registros/modi-usuario.php?id=<?php echo $id?>&nombre=<?php echo $nombre ?>&tipo=<?php echo $tipo ?>&password=<?php echo $password ?>" type="button" class="btn btn-success" >Guardar</a>
